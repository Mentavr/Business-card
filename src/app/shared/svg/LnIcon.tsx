...
const LnIcon = () => {
    ...
    const mouseEnter: MouseEventHandler<HTMLOrSVGElement> = () => {
        setHover(true);
    };
    const mouseLeave: MouseEventHandler<HTMLOrSVGElement> = () => {
        setHover(false);
    };
    return (
        <svg
        ...
        >
            <path
                ...
                className={`${isHover ? 'fill-[#D3E97A] desktop:fill-[orange]' : 'fill-[#D3E97A]'}`}
            />
            <path
